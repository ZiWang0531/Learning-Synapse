...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#050505] text-white font-sans selection:bg-violet-500/30">
      ...
      {graphData.nodes.length > 0 && (
          <div className="absolute bottom-4 right-4 z-10 w-64 h-48 md:h-64 animate-slide-in-right flex flex-col gap-2">
              {/* Finish Button */}
              <button 
                onClick={() => setShowSummary(true)}
                className="bg-emerald-600/90 hover:bg-emerald-500 text-white font-bold py-2 px-4 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2"
              >
